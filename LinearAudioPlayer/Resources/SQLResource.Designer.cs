...
namespace FINALSTREAM.LinearAudioPlayer.Resources {
    ...
    internal class SQLResource {
        ...
        /// <summary>
        ///   UPDATE PLAYINGLIST SET SORT = SORT + 1 WHERE SORT &gt; 1 に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   SELECT ID FROM PLAYINGLIST WHERE SORT = 1 に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   UPDATE PLAYINGLIST SET SORT = SORT -1 に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   UPDATE PLAYINGLIST SET SORT = :Sort WHERE SORT = 0 に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   SELECT ID FROM PLAYINGLIST WHERE SORT = 2 に類似しているローカライズされた文字列を検索します。
        /// </summary>
